...
> Live browser preview: [Rula on ai.igor-ya.ru](https://ai.igor-ya.ru/). The preview exposes the browser demo surface; model inference and the target voice runtime remain local / on-prem.
...
The MIT license covers this repository's source code and documentation. Model weights, third-party assets, and external runtimes are governed by their upstream licenses.
